-- ============================================================
-- COMBINED SCRIPT: Migration + Complete Data Import
-- Run this ONCE in Supabase SQL Editor
-- ============================================================

-- STEP 1: Add new columns to households table
-- ============================================================
...
-- STEP 2: Delete existing Venkatapura data and re-import with all columns
-- ============================================================

-- Delete existing households to avoid duplicates
DELETE FROM households WHERE village_id = '9fff07b3-9ad0-47b8-b18c-65c3a828affe';

-- Now paste the contents of venkatapura_complete_import.sql below this line
-- (Everything after the DELETE statement in that file)
...
-- ✅ Migration complete! All 17 Google Form fields are now in the database!
